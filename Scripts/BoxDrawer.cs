...
public class BoxDrawer : MonoBehaviour
{
    ...
    public class Box
    {
        ...
        public Box(Vector3 center,Quaternion rotation,Color color,Vector3 halfSize,float lineWidth=DefaultLineWidth*3.0f)
        {
            Center = center;
            Rotation = rotation;
            Color = color;
    ...
    protected bool Draw_Box(Vector3 center, Quaternion rotation, Color color, Vector3 halfSize, float lineWidth=DefaultLineWidth)
    {
        ...
        //Vevtor3.right是Vector3(1,0,0)的简写
